...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    /** enable content show(是否显示标题) */
    protected boolean mIsContentShow = true;
    ...
    public void setUiBeforShow() {
        ...
        /** content */
        mTvContent.setVisibility(mIsContentShow ? View.VISIBLE : View.GONE);
